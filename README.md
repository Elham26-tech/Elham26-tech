...
اپلیکیشن موبایل پلتفرم جامع دیجیتال صنعت سنگ و معدن. ورود با شماره موبایل و کد یک‌بارمصرف، رابط فارسی راست‌به‌چپ با حالت انگلیسی، و هفت ماژول نقشهٔ محصول.
...
| مدیریت معدن و کارخانه | `app/mine/` | موجودی بچ‌ها، نمودار تولید هفتگی، سفارش‌های کار با درصد پیشرفت |
| بازارچه فروش B2B | `app/(app)/market/` | جستجو، فیلتر دسته، مشخصات فنی، علاقه‌مندی‌ها |
| مزایده زنده | `app/(app)/auction/` | شمارش معکوس، اعتبارسنجی گام پیشنهاد، تاریخچهٔ پیشنهادها |
| شبیه‌ساز و ویژوالایزر | `app/(app)/visualizer/` | انتخاب/عکس‌برداری از فضا، امتیازدهی بر اساس سبک، فضا و دوام |
| همکاری در فروش | `app/affiliate/` | لینک اختصاصی، بازدید/سرنخ/فروش، پورسانت و تسویه |
